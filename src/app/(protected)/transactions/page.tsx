    ...
    <div className="relative z-10 flex flex-col w-full">
      ...
      <div className="grid grid-cols-1 max-w-screen-2xl mx-auto px-4 w-full">
        <Card className="-mt-24 w-full">
          <div className="bg-default-300s p-8 max-h-screen">
            {/* <h1 className="text-2xl pb-2 font-bold mb-2">History</h1> */}
            ...
            <div className="overflow-scroll [max-height:calc(100vh-400px)]">
              <Table
                isHeaderSticky
                removeWrapper
